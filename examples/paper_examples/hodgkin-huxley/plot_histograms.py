...
patch_list = []
patch_list.append(Patch(edgecolor="black", facecolor=colors[0], hatch="", label="fine grid PDE models"))
patch_list.append(Patch(edgecolor="black", facecolor=colors[1], hatch="", label="medium grid PDE models"))
patch_list.append(Patch(edgecolor="black", facecolor=colors[2], hatch="", label="coarse grid PDE models"))
patch_list.append(Patch(edgecolor="black", facecolor=colors[3], hatch="", label="ODE models"))
