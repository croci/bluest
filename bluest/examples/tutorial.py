...
# Due to rounding errors (and other reason), estimating these from the covariance is not a good idea.
# We do it here just to show you how it is done. Only upper triangular block is needed,
